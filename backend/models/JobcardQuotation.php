...
/**
 * This is the model class for table "jobcard_quotation".
 *
 * @property int $id
 ...
 * @property int $status
 */
class JobcardQuotation extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
