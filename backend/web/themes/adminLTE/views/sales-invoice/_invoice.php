            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td width="50%" style="font-size: 20px; font-weight: bold; text-transform: uppercase; text-align: center; padding: 10px;">Sales Invoice</td>
                        <td width="25%" style="padding: 10px;"></td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                <td width="40%" style="padding: 3px 0; font-size: 14px; font-weight: 700;">Customer Address</td>
                                                <td width="60%" style="padding: 3px 0; font-size: 14px;">: <?php echo $invoice->customer->address;?></td>
                                            </tr>
                                           <!--  <tr>
                                    ...
                                    <td>
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60%" style="padding: 3px 0; font-size: 14px;">: <?php echo $invoice->inv_created_date?></td>
                                            </tr>
                                            <tr>
                        ...
                        <td width="100%">
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                <tr>
                                    ...
                                    <th width="12.5%" style="border:1px solid #ddd; border-bottom: none; padding: 5px 10px; font-size: 14px; font-weight: 700; text-transform: uppercase; text-align: right;"><?php echo Yii::$app->common->number_format($invoice->subtotal);?></th>
                                </tr>
                                <tr>
                                    ...
                                    <th width="12.5%" style="border:1px solid #ddd; border-bottom: none; border-top: none; padding: 5px 10px; font-size: 14px; font-weight: 700; text-transform: uppercase; text-align: right;"><?php echo Yii::$app->common->number_format($invoice->discount);?></th>
                                </tr>
                                <tr>
                                    <th width="50%" style="border:1px solid #ddd; border-bottom: none; border-top: none;"></th>
                                    ...
                                    <!-- <th width="12.5%" style="border:1px solid #ddd; border-bottom: none; border-top: none; padding: 5px 10px; font-size: 14px; font-weight: 700; text-transform: uppercase; text-align: right;"><?php //echo $invoice->net_amount;?></th> -->
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th width="12.5%" style="border:1px solid #ddd; border-bottom: none; border-top: none; padding: 5px 10px; font-size: 14px; font-weight: 700; text-transform: uppercase; text-align: right;"><?php echo $invoice->grand_total;?></th>
                                </tr>
