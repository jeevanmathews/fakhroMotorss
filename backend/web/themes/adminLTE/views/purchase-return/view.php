...
$this->title = (($model->prefix)?$model->prefix->prefix.'-'.$model->prtn_number:'');
$this->params['breadcrumbs'][] = ['label' => 'Purchase Return', 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="purchase-return-view main-body" id="purchase-return_view">
                    ...
                    <div class="row">
                        <div class="col-md-12"> 
                            ...
                            <?= DetailView::widget([
                                ...
                                'value'=>(($model->prefix)?$model->prefix->prefix.'-'.$model->prtn_number:''),
                                ],
                                ['label'=>'Supplier',
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <tbody class="item_table">
                                ...
                                <?php
                                if($model->returnitems):
                                    foreach ($model->returnitems as $req) { ?>
                                <tr class="item_row" rid="1">
                                <td><?= $req->item->item_name?></td>
                                <?php if($model->grn_id || $model->inv_id): ?>
