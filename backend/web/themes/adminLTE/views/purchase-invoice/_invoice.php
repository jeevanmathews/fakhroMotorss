            ...
            <td>
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td width="50%" style="font-size: 20px; font-weight: bold; text-transform: uppercase; text-align: center; padding: 10px;">Purchase Invoice</td>
                        <td width="25%" style="padding: 10px;"></td>
                    </tr>
                </table>
                                    ...
                                    <td>
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="60%" style="padding: 3px 0; font-size: 14px;">: <?php echo $invoice->supplier->name;?></td>
                                            </tr>
                                            <tr>
                                                <td width="40%" style="padding: 3px 0; font-size: 14px; font-weight: 700;">Supplier Address</td>
                                                <td width="60%" style="padding: 3px 0; font-size: 14px;">: <?php echo $invoice->supplier->address;?></td>
                                            </tr>
                                           <!--  <tr>
