...
<?php $form = AutoForm::begin(["id" => "purchase-return-".time().(($model1->isNewRecord)?"createprtninv":"update")."-form"]); ?>
<div class="box-body">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-6"> 
                   ...
                   <div class="form-group field-deliveryorder-do_number">
                      <div class="input-group">
                        ...
                        <?= Html::textInput('invnumber', $model->prefix->prefix.' '.$model->inv_number, ['class'=>'form-control disabled']); ?>
                      </div>
                    </div>
                    
                    <?= $form->field($model1,'prefix_id', ['inputOptions' => ["class" => "form-control select2",'disabled'=>true]])->dropDownList(ArrayHelper::map(PrefixMaster::find()->where(["status" => 1])->all(), 'id', 'prefix'), ["prompt" => "Select Prefix",'value'=>(isset(Yii::$app->common->prefix->id)?Yii::$app->common->prefix->id:'')]) ?>
