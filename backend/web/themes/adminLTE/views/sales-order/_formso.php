...
<div class="box-body">
  <div class="row">
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-6"> 
          <?= $form->field($model1,'qtn_id', ['inputOptions' => ["class" => "select_pr form-control select2"]])->dropDownList(ArrayHelper::map(Qutation::find()->where(["status" => 1])->all(), 'id', 'qtn_number'),['value'=>$model1->id], ["prompt" => "Select Items"]) ?>
          ...
          <tbody class="item_table">
            ...
            <tr class="item_row" rid="1">
              ...
              <td><?= $form->field($model1, 'price[]')->textInput(['class'=>'form-control price'])->label(false) ?>
                <input type="" class="total_price" name="SalesInvoiceItems[total_price][]">
              </td>
              <?php //if($vat_format=="inclusive") :?>
              <td>
            ...
            <tr class="item_row" rid="1">
              ...
              <td><?= $form->field($req, 'price[]')->textInput(['value'=>$req->price,'class'=>'form-control price'])->label(false) ?>
                <input type="" class="total_price" value="<?=$req->total_price?>" name="SalesInvoiceItems[total_price][]">
              </td>
              <?php if($vat_format=="inclusive") :?>
              <td>
                <div id="" role="radiogroup" aria-invalid="true">
     ...
     <div class="w50 pull-right">
      <div class="mb-5 fl-w100"><?= $form->field($model1, 'subtotal')->hiddenInput(['value'=>$model->subtotal,'class'=>'form-control subtotal'])->label(false) ?></div>
      <?php //if($vat_format=="inclusive") :?>
    ...
    <?php //endif;?>
    <div class="mb-5 fl-w100"><?= $form->field($model1, 'grand_total')->hiddenInput(['value'=>$model->grand_total,'class'=>'form-control grandtotal'])->label(false)//['readonly'=>true]?></div>
  </div>
...
//           console.log(clone.find(".field-salesorderitems-item_id").children().children('span'));
...
//         $(thisrow).find('#salesorderitems-price').val(response.selling_price);
//         $(thisrow).find('#salesorderitems-tax').val(response.vat);
//         $(thisrow).find('#salesorderitems-unit_id').val(response.unit_id);
