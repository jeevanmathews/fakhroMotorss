...
<div class="content-main-wrapper">
    ...
    <!-- SELECT2 EXAMPLE -->
        ...
        <div class="col-md-12"> 
        <p>
              <?php if(Yii::$app->common->checkPermission('BranchesController', 'create', 'true')){
            echo Html::a('Create Branches', ['create'], ['class' => 'btn btn-success']);
        } ?>  
            </p>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
					...
					'template' => ((Yii::$app->common->checkPermission('BranchesController', 'update', 'true')?'{update}':'').(Yii::$app->common->checkPermission('BranchesController', 'changestatus', 'true')?'{changeStatus}':'').(Yii::$app->common->checkPermission('BranchesController', 'view', 'true')?'{view}':'')),
