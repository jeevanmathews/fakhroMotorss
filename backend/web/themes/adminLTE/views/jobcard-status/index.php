...
/* @var $searchModel backend\models\JobcardStatusSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jobcard Status';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="content-main-wrapper main-body" id="jobcard-status_index">
    ...
    <p>
        <?= Html::a('Create Jobcard Status', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
