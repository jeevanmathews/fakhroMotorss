...
/* @var $searchModel backend\models\suppliergroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Suppliergroups';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="content-main-wrapper main-body" id="suppliergroup_index">
    ...
    <p>
        <?= Html::a('Create Suppliergroup', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
