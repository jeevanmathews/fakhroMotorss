...
<?php $form = AutoForm::begin(["id" => "purchase-invoice-".time().(($model->isNewRecord)?"createpoinv":"update")."-form"]); ?>
<div class="box-body">
    <div class="row">
        <div class="col-md-12">
                        ...
                        <tbody class="item_table">
                            ...
                            <tr class="item_row" rid="1">
                                ...
                                <td>
                                  ...
                                  <?= Html::activeTextInput($modelpr,'grn_quantity[]',['type'=>'hidden','class'=>'','value'=>(($req->remaining_quantity!=0)?$req->remaining_quantity:$req->quantity)])?>
