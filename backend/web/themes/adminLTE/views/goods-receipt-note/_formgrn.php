       ...
       <table class="table table-bordered">
        ...
        <tr class="item_row" rid="1">
          <td>
           ...
           <td>
              <?= Html::activeTextInput($modelpr,'po_quantity[]',['type'=>'','class'=>'form-control disabled','value'=>(($req->remaining_quantity!=0)?$req->remaining_quantity:$req->quantity)])?></td>
            <td><?= $form->field($modelpr, 'quantity[]')->textInput(['class'=>'qty form-control','value'=>(($req->remaining_quantity!=0)?$req->remaining_quantity:$req->quantity)])->label(false) ?>
          </td>
