...
//                 $(thisrow).find('#purchaserequestitems-price').val(response.selling_price);
//                 $(thisrow).find('#purchaserequestitems-tax').val(response.vat);
//                 $(thisrow).find('#purchaserequestitems-unit_id').val(response.unit_id);
