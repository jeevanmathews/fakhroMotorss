            ...
            <div class="row">
                <div class="col-md-12"> 
                    <p>
                     ...
                     <?php Pjax::begin(['id'=>'purchase-return'.time()]); ?>
                    <?= GridView::widget([
                        ...
                        'filter' => Html::activeDropDownList($searchModel, 'prtn_created_by', ArrayHelper::map(User::find()->all(), 'id', 'firstname'),['class'=>'form-control','prompt' => 'Search by User']),
                        ],
                        [
