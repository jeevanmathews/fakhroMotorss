...
?>
<div class="content-main-wrapper main-body"  id="vehicletype_index">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12"> 
                    <p>
                      <p>
						<?php if(Yii::$app->common->checkPermission('VehicletypeController', 'create', 'true')){
							echo Html::a('Create Vehicle Type', ['create'], ['class' => 'btn btn-success']);
						} ?> 
                    </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
							...
							'template' => ((Yii::$app->common->checkPermission('VehicletypeController', 'update', 'true')?'{update}':'').(Yii::$app->common->checkPermission('VehicletypeController', 'changestatus', 'true')?'{changeStatus}':'')),
